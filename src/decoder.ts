export class MsgPackDecoder {
    ...
    private static decoders: {[id: number]: (t: MsgPackDecoder, ...args:any[]) => any} = {
        ...
        0xc8: (t) => t.decodeExt(t.bufferView.getUint8(t.cursor++), t.bufferView.getUint16((t.cursor+=2) - 2)),
        0xc9: (t) => t.decodeExt(t.bufferView.getUint8(t.cursor++), t.bufferView.getUint32((t.cursor+=4) - 4)),
        0xca: (t) => t.bufferView.getFloat32((t.cursor += 4 )- 4),
        0xcb: (t) => t.bufferView.getFloat64((t.cursor += 8 )- 8),
        0xcc: (t) => t.bufferView.getUint8(t.cursor++),
        0xcd: (t) => t.bufferView.getUint16((t.cursor+=2) - 2),
        0xce: (t) => t.bufferView.getUint32((t.cursor+=4) - 4),
    ...
    static {
        ...
        // decode fixext
        for(let i = 0; i <= 4; i++) 
            MsgPackDecoder.decoders[i + 0xd4] = (t) => t.decodeExt(t.bufferView.getUint8(t.cursor++), 2**i);
    }
    ...
    decodeExt(type: number, len: number) {
